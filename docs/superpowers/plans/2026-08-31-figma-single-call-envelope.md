...
- [x] **Step 1: Add opt-in read-only live contract assertions**
...
- [x] **Step 2: Run the authenticated live contract when credentials are available**

  Use the authenticated official host Figma MCP without reading or printing its token. Record actual call count and fallback status in the test output.

- [x] **Step 3: Add user-facing documentation and changepack**
...
- [x] **Step 4: Run focused and workspace verification from a clean environment**
...
- [x] **Step 5: Inspect the final diff for privacy, scope, and generated artifacts**
...
- [x] **Step 6: Install the verified binary for Codex**
